...
struct ExportSettingsFacts: Codable, Sendable {
    ...
    /// format checked — the second deliberate dialog write (a check that fails cancels the bounce up front);
    ...
    enum CodingKeys: String, CodingKey { case format, bitDepth, normalize, normalizeSwitchedFrom, formats, pcmFormatCheckedByApp }
