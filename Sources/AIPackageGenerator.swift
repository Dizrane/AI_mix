  ...
  "actions": [
    {
      ...
      "reason": "One factual sentence naming the current known value, the absolute target and the evidence above"
    },
    {
      "id": "action_002",
      "target": { "trackID": "track_2" },
